...
a:hover {
    ...
    text-decoration: underline;
        ...
        <form action="?" method="POST">
          <p class="center">
            <img width="238" src="wp-content/plugins/wp-admin-bruteforce-protection-and-notification/images/logo_siteguarding.png" />
          </p>
          <p class="tbig center">
...
function CheckRecaptcha($captcha_key_session, $response_google, $try = false)
{
    ...
    if($response['success'] != 1)
    {
        ...
        <html>
        <head>
        <META HTTP-EQUIV="Refresh" CONTENT="3;url=/administrator/index.php">
        </head>
        <body>
